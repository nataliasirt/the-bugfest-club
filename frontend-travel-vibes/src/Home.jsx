...
import beachSunset from "./assets/images/beach-sunset1.svg"; // Updated import to match your file
      ...
      <div className="flex items-center justify-center w-full max-w-[1280px] mt-20 space-x-4 sm:space-x-8">
        ...
        <div className="w-1/2 h-[600px] overflow-hidden hidden sm:block">
          <img
            ...
            className="w-full h-full object-contain rounded-[50px] max-w-full max-h-full" // Adjusted for SVG sizing
          />
        </div>
        ...
        <div className="bg-white rounded-[25px] border border-gray-300 shadow-lg p-8 w-[600px] sm:rounded-l-[25px]">
          ...
          <div className="flex items-center space-x-3">
            <button className="bg-black text-white px-5 py-3 rounded-lg text-lg">
              Form
            </button>
            <input
              type="text"
