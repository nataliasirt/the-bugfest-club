...
const CreateTripForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:8080/api/trips/user/2", {
        method: "POST",
        headers: {
        ...
        <div className="flex flex-col md:flex-row p-5 md:gap-20">
          ...
          <div className="w-full mb-6 md:w-1/2 md:mb-0">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">
              Your Feeling, Your Journey {/* Trip Title - from OpenAI */}
            </h2>
              ...
              <form className="space-y-4 text-left" onSubmit={handleSubmit}>
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-2 border rborder-gray-300 rounded-md focus:ring-2 bg-gray-50 text-gray-600 text-s"
                    required
                  >
                    <option value=""></option>
                ...
                <div className="flex gap-3 mt-6">
                  <button
                    type="submit"
                    className="flex-1 py-2  rounded-lg hover:bg-gray-500 flex items-center justify-center text-white"
                  >
                    Find my trip
                  </button>
                </div>
